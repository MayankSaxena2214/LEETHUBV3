...
<pre><span style="font-size: 18px;"><strong>Input: </strong>k = -10,<strong> </strong>arr = [10, 2, -2, -20, 10]
<strong>Output:</strong> 3
<strong>Explaination:</strong> 
Subarrays: arr[0...3], arr[1...4], arr[3..4]
have sum exactly equal to -10.</span></pre>
<pre><span style="font-size: 18px;"><strong>Input: </strong>k= 33, arr = [9, 4, 20, 3, 10, 5]
