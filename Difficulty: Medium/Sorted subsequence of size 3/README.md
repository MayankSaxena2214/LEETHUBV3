<h2><a href="https://www.geeksforgeeks.org/problems/sorted-subsequence-of-size-3/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=practice_card">Sorted subsequence of size 3</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array arr, find any 3 elements in it such that <strong>arr[i] &lt; arr[j] &lt; arr[k] </strong>and<strong> i &lt; j &lt; k.<br></strong></span></p>
<p><span style="font-size: 18px;"><em><strong>Note</strong>:</em> </span></p>
<ol>
...
Explanation: </strong>No such Subsequence exist, so empty array is returned.</span></pre>
